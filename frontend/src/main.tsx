    ...
    <ConfigProvider
      ...
      theme={{
        ...
        token: {
          ...
          controlHeight: 40,
          controlHeightSM: 32,
          boxShadow: currentTheme === 'dark' ? '0 1px 3px rgba(0,0,0,0.3), 0 1px 2px rgba(0,0,0,0.25)' : '0 1px 3px rgba(11,18,32,0.06), 0 1px 2px rgba(11,18,32,0.04)',
        },
        components: {
          Layout: {
          ...
          Menu: {
            ...
            itemColor: currentTheme === 'dark' ? '#8896AB' : '#667085',
            itemHoverColor: '#2563EB',
            itemSelectedColor: '#2563EB',
            itemSelectedBg: currentTheme === 'dark' ? 'rgba(37, 99, 235, 0.18)' : 'rgba(37, 99, 235, 0.08)',
            itemHoverBg: currentTheme === 'dark' ? 'rgba(37, 99, 235, 0.10)' : 'rgba(37, 99, 235, 0.04)',
            itemBorderRadius: 10,
            itemMarginInline: 8,
            collapsedWidth: 72,
          },
          ...
          Table: {
            headerBg: currentTheme === 'dark' ? '#1A2238' : '#F0F4FA',
            headerColor: currentTheme === 'dark' ? '#8896AB' : '#667085',
            headerSortActiveBg: currentTheme === 'dark' ? '#2A3350' : '#E4E9F2',
            headerSortHoverBg: currentTheme === 'dark' ? '#2A3350' : '#E4E9F2',
            bodySortBg: currentTheme === 'dark' ? '#1A2238' : '#F6F8FC',
            rowHoverBg: currentTheme === 'dark' ? 'rgba(37, 99, 235, 0.12)' : 'rgba(37, 99, 235, 0.04)',
            borderColor: currentTheme === 'dark' ? '#1E2740' : '#F0F2F5',
            borderRadius: 16,
          },
          Modal: {
